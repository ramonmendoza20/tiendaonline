    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">R E G I S T R A R S E</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                            <label for="birthday" class="col-md-4 control-label">Fecha de Nac</label>
                        ...
                        <div class="form-group{{ $errors->has('sexo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- <input id="sexo" type="email" class="form-control" name="sexo" value="{{ old('sexo') }}" required> -->
                                @if ($errors->has('sexo'))
                                    <span class="help-block">
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label">Confimar contraseña</label>
